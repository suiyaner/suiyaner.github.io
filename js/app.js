...
$.extend({
    message: function (e) {
        ...
        var i, o, s, t = n.showClose ? '<div class="c-message--close">×</div>' : "",
            ...
            n.type + '"></i><div class="el-notification__group">' + a +
            '<div class="el-notification__content">' + n.message + "</div>" + t + "</div></div>",
            m = $("body"),
            d = $(c);
        o = function () {
            d.addClass("slideOutRight"), d.one(
        ...
        }, $(".c-message").remove(), m.append(d), d.one(
            "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
            function () {
